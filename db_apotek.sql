...
-- Dumping database structure for db_apotek
CREATE DATABASE IF NOT EXISTS `db_apotek` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_apotek`;
...
REPLACE INTO `tbl_m_drug` (`id_tmd`, `id_tmc`, `id_tmdu`, `brand_tmd`, `name_tmd`, `buy_tmd`, `sale_tmd`, `expired_date_tmd`, `stock_drug_tmd`, `status_tmd`, `status_deactivated_tmd`, `status_deleted_tmd`, `created_by_tmd`, `created_date_tmd`, `updated_by_tmd`, `updated_date_tmd`) VALUES
	(24, 13, 3, 'OBH', 'Combi', 8000, 12000, '2024-01-06', 47, 'Aktif', 0, 0, NULL, '2023-12-19 12:11:21', NULL, '2023-12-23 15:19:42');
...
-- Dumping data for table db_apotek.tbl_m_user: ~2 rows (approximately)
REPLACE INTO `tbl_m_user` (`id_tmu`, `nik_tmu`, `name_tmu`, `address_tmu`, `gender_tmu`, `username_tmu`, `email_tmu`, `password_tmu`, `role_tmu`, `birth_place_tmu`, `birth_date_tmu`, `contact_tmu`, `status_deactivated_tmu`, `status_deleted_tmu`, `created_by_tmu`, `created_date_tmu`, `updated_by_tmu`, `updated_date_tmu`) VALUES
	(150, NULL, 'Fajri Yanuar', 'Perumahan Karaba Indah', 'Laki-Laki', 'fajri01', 'fajriyanuar1@gmail.com', '$2y$10$NjiYK095oRwPMIMvl3rEc.jLEF0Jfv00w9A741SUKEIEc2q7.lq56', 'Owner', NULL, NULL, '+6285217861296', 0, 0, NULL, '2023-12-19 00:06:15', NULL, NULL),
	...
	(154, NULL, 'Haejoon', 'Perumahan Karaba Indah', 'Laki-Laki', 'haejoon01', 'leehaejoon100@gmail.com', '$2y$10$TmU7MOjAM4C.fPzFYgpR6OMAHlbpKAwz1sxNpmuI.DuG6bpz8qpxy', 'Admin', NULL, NULL, '+6282260019103', 0, 0, NULL, '2023-12-21 08:59:09', 150, '2023-12-21 14:32:35'),
	(155, NULL, 'fadel', 'Terangsari', 'Laki-Laki', 'fadel01', 'fadelraihanas@gmail.com', '$2y$10$lh6a4O8YkIsHJrMwjFd/NeVfCWZlQ9T3wlcW.1y//Bnt0pen.FaYi', 'Owner', NULL, NULL, '+6284627289262', 0, 0, 150, '2023-12-22 11:40:33', 150, '2023-12-22 11:40:54');
